...
- `artifacts/` : Existing project design/prototype artifacts.
- `artifacts/` : Implementation-plan artifacts generated by `make-plan-aron` (caller-required spelling).
...
- Use [`artifacts/PLAN_2026_08_13_feedback_follow_up.md`](artifacts/PLAN_2026_08_13_feedback_follow_up.md) for current full-height field + approved card-list implementation order and acceptance gates.
...
├── artifacts/                      # Existing design/prototype agent artifacts
├── artifacts/                      # make-plan-aron plan indexes/tickets/HTML
├── docs/
