...
- Goal: duel feedback round 4 — YGO story duel simulator (Svelte 5). Grill outcome (confirmed, `artifacts/GRILL_2026_08_16_duel_feedback_round_4/ANSWERS.md` round 2): preview panel gains a stats row so main stats are readable as text, not only off the card art.
