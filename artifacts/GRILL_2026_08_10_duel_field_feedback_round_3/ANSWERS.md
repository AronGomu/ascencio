...
- Playwright needs `PLAYWRIGHT_BROWSERS_PATH=/home/aron/projects/ascencio/.tmp/pw-browsers` and the pinned nix `-p` list; chromium only, foreground, `webkit-smoke` unrunnable on this host. Source: `artifacts/HANDOFF_2026_08_10_duel_field_feedback_round_2.md`.
