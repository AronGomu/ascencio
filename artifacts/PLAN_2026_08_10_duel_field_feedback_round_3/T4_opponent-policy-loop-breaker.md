...
- Files edited: `src/worker/opponent/OpponentPolicy.ts`, `tests/unit/opponent-policy.test.ts`, `tests/fixtures/transcripts/basic-duel-v1.json`, `tests/fixtures/transcripts/tribute-special-v1.json`, `tests/fixtures/transcripts/effects-recovery-v1.json`, `artifacts/manual_test_checklist.md`.
