...
- **A1** Artifacts land in `artifacts/` (the tracked dir declared in `AGENT.md`), not `artifacts/`. Carried forward from the 2026-08-08 plan.
...
- **A16** Playwright needs the nix closure documented in `artifacts/HANDOFF_2026_08_09_duel_field_ux_overhaul.md`. Every ticket that lists an e2e command repeats it inline; do not try to merge the chromium and firefox invocations.
...
- Prior plan `artifacts/PLAN_2026_08_08_duel_field_ux_overhaul.md`
- Environment facts `artifacts/HANDOFF_2026_08_09_duel_field_ux_overhaul.md`
</content>
</invoke>
