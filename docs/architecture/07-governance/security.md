...
- Never trust DOM/presentation/UI state for legality or engine responses.
- Offline solo hidden information is not a Worker/main-thread security boundary. Tag visibility explicitly; prevent hidden identities from plain UI, accessibility, image requests, screenshots, routine logs, and diagnostics.
