...
**Evidence:** `0431136` (`feat(card-list): split target chrome and stable collapse`). Baseline gates repaired by `73a4eb8` (`fix(card-list): restore target dialog baseline gates`).
