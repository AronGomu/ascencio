...
export const CARD_LIST_TARGET_CHROME: CardListAcceptanceScenario = Object.freeze({
  ...
  targetEntries: Object.freeze(
    targetLocations.map((location, index) => {
      const choice = Object.freeze({
        ...
        cardAddress: Object.freeze({ controller: 0 as const, location, sequence: index }),
      });
      const names = { extra: "Extra Deck", graveyard: "Graveyard", banished: "Banished", deck: "Deck" } as const;
      return Object.freeze({
        ...
        zoneBadge: names[location].toUpperCase() as OffFieldTargetEntry["zoneBadge"],
...
export function cardListAcceptanceScenario(id: AcceptanceScenarioId): CardListAcceptanceScenario {
  switch (id) {
    ...
    case "card-list-target-chrome": return CARD_LIST_TARGET_CHROME;
