...
interface FixtureCard {
  readonly asset: AssetDeckCardRecord;
  readonly text: PackagedCardText;
}

function fixture(input: FixtureInput): FixtureCard {
...
const PROTOTYPE_CATALOG_CARDS: readonly FixtureCard[] = Object.freeze([
  fixture({
    code: 10000000,
...
export const PROTOTYPE_CATALOG_ASSETS: readonly AssetDeckCardRecord[] =
  Object.freeze(PROTOTYPE_CATALOG_CARDS.map(({ asset }) => asset));

export const PROTOTYPE_CATALOG_TEXTS: readonly PackagedCardText[] =
  Object.freeze(PROTOTYPE_CATALOG_CARDS.map(({ text }) => text));

export const PROTOTYPE_CATALOG_RECORDS: readonly DeckCatalogRecord[] =
  packagedCatalogRecords(PROTOTYPE_CATALOG_ASSETS, PROTOTYPE_CATALOG_TEXTS);
