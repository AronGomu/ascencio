...
> Scope: offline duel client with implemented full-height shell, UI persistence v2 and card-list successor, integrated experience prototypes, and accepted three-domain application topology
