...
- `artifacts/HANDOFF_2026_08_10_duel_field_feedback_round_2.md` — round 2's verified gate table and the environment facts repeated below.
- `artifacts/manual_test_checklist.md` — 164 steps, of which 22 remain unticked. They are human-at-a-browser checks. The user has accepted them as outstanding; do not block on them and do not tick them.
...
| Plan survives on correct branch | `git rev-parse --abbrev-ref HEAD`; `git log --oneline -- artifacts/PLAN_2026_08_10_duel_field_feedback_round_3.md` | `feat/duel-field-round-3`; docs-only plan commit present |
