...
- **A12** Preview panel = fixed `22rem` column right of the field, equal height, content sticky after pointer leaves, stacks below the field under `64rem` viewport width.
