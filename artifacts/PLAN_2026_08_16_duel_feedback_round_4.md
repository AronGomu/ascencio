...
All judgment calls grilled + confirmed by user — full record: `artifacts/GRILL_2026_08_16_duel_feedback_round_4/ANSWERS.md` (2 rounds, 12 decisions, scout facts). Highlights:
...
- Existing `artifacts/` + `docs/ADR/` naming conventions kept.
