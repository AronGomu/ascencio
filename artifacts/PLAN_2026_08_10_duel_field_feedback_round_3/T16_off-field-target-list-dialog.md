...
- [x] 11. Run focused/full tests and four manual deck duels. — criterion: every automatable gate green (see Validation). The four-deck duels stay a human gate and are published to `artifacts/manual_test_checklist.md`; no automated run may stand in for them.
...
- [ ] manual one duel per Burning Abyss/Nekroz/Shaddoll/Spellbook; any encountered off-field/mixed target remains answerable — human gate, published to `artifacts/manual_test_checklist.md`
...
- [ ] app functional — browse lists, mixed target, cancel, singleton, multi all answerable — human gate in a live duel, published to `artifacts/manual_test_checklist.md` (automation covers singleton/multi/mixed/browse structurally, but not a live cancel of an engine-cancelable off-field prompt)
