...
| [`deck-selection-screen-design.html`](deck-selection-screen-design.html)                                                               | Validated final visual/interaction design for the duel-start deck-selection screen        |
